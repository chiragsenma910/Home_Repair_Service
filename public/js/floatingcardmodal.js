document.addEventListener('DOMContentLoaded', function () {
  ...
  function setupModal() {
    ...
    const floatingSpan = document.getElementsByClassName('floating-card-close')[0];
  ...
  function setupTaskForm() {
    ...
    const termsCheckboxes = document.querySelectorAll('#step2 input[type="checkbox"]');
  ...
  function validateTerms() {
    const termsCheckboxes = document.querySelectorAll('#step2 input[name="terms"]');
  ...
  function submitTaskForm() {
    ...
    const professionElement = document.querySelector('.worker-card .profession');
    ...
    // console.log('Task Time:', data.taskTime);
  
    // // Check for null fields
    // if (!data.workerId || !data.workerType || !data.taskDetails || !data.taskDate || !data.taskTime) {
